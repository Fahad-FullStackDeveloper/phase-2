...
- How does authentication work when [authentication edge case]?
...
- **FR-006**: System MUST authenticate users via [authentication method] with JWT tokens
- **FR-007**: System MUST store data in Neon Serverless PostgreSQL database
- **FR-008**: System MUST expose RESTful API endpoints following the specified contract
- **FR-009**: System MUST ensure user data isolation (each user only sees their own data)
